...
export default function About() {
  return (
    <div className='mb-24'>
      ...
      <p className='mx-96 text-lg'><span className='font-medium'>Thank you for giving me this opportunity to display my skills.</span> Over the past week I designed and implemented a full-stack ML based app that can analyze and provide insights on a bank statement. This page is here to describe the architecture and technologies that were used and the reasons behind them.</p>
      <h2 className='text-center text-3xl mt-8 mb-4 font-light'>Model Architecture</h2>
      <p className='mx-96 text-lg'>The first thing I did when I looked at the challenge page, was realize that I didn’t really know what a good or bad bank statement was. I did some research and found that there were many different measures of reliability. I ended up using a linear regression model as it could measure</p>
      <ul className='mx-[24em] text-lg my-2'>
      ...
      <p className='mx-96 text-lg'>This score, along with descriptions of each point would help provide insights to the bank.
      </p>
      <h2 className='text-center text-3xl mt-8 mb-4 font-light'>Website Design</h2>
      <p className='mx-96 text-lg mb-2'>
